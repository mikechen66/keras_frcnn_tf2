...
from keras_frcnn import config_test
...
def predict(args_):
    ...
    # For pretrained one, please put the weights inside model dir. Change cfg.model_path 
    # in line 173-175 with cfg.base_net_weights, this cfg.base_net_weights 
    # is pointed to your model that you just downloaded in model dir (by Keras-frcnn config.py).
