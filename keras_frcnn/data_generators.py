...
class SampleSelector:
    def __init__(self, class_count):
        # Ignore the classes that have zero samples
...
def calc_rpn(C, img_data, width, height, resized_width, resized_height, img_length_calc_function):
    ...
    # Get the GT box coordinates, and resize to account for image resizing and onvert the label 
    # bbox to resized image, just change the ratio according to resize/original_size
                ...
                for jy in range(output_height):
                    ...
                    for bbox_num in range(num_bboxes):
                        ...
                        if img_data['bboxes'][bbox_num]['class'] != 'bg':
                            ...
                            # Set the anchor to positive if the IOU is > 0.7
                    ...
                    if bbox_type == 'neg':
                        ...
                        # Get 36 after summing two kind of indexes of which each index is a tuple (0,1,2)
    ...
    # One issue is that the RPN has more negative than positive regions, so we turn off some of the negative
    # regions and limit it to 256 regions.
    num_regions = 256
